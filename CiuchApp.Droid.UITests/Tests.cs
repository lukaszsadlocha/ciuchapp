...
using CiuchApp.Droid;

namespace CiuchApp.Droid.UITests
{
	...
	public class Tests
	{
        ...
        private readonly int countrySpinnerId = 11;// Resource.Id.countrySpinner;
        private readonly int citySpinnerId = 11;//Resource.Id.citySpinner;
        private readonly int currencySpinnerId = 11;//Resource.Id.currencySpinner;
        private readonly int pieceImage = 11;//Resource.Id.PieceImage;
